# Initial findings — the Bash `ytdl`, and the evolutions asked for

> **Provenance.** Extracted verbatim on 2026-08-26 from `docs/improvements.md` (lines 3–164), where
> it was written on 2026-07-21 under the title *Improvements & Evolutions*. **Two
> kinds live in it**, and the identifiers keep them apart: `C`/`U`/`M` are a **code
> analysis** of the Bash tool as it then stood; `E1`/`E2` are **requirements** — the
